...
public class QComments extends EntityPathBase<Comments> {
    ...
    private static final long serialVersionUID = -1070228845L;
    ...
    public final ComparablePath<Character> comment_delyn = createComparable("comment_delyn", Character.class);
